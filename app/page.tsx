...
const sections = [
  { title: "Sleep & Recovery", href: "/sections/sleep", icon: "😴" },
  { title: "Nutrition for Performance", href: "/sections/nutrition", icon: "🥗" },
  { title: "Brain Performance & Concussion", href: "/sections/brain", icon: "🧠" },
  { title: "Injury Prevention", href: "/sections/injury", icon: "🦵" },
  { title: "Transition Out of Sport", href: "/sections/transition", icon: "🔄" },
  { title: "Additional Supports", href: "/sections/supports", icon: "🤝" },
];
